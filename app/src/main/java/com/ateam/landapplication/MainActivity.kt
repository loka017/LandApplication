...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mRoomList.add(Room(24500,"서울시 서대문구", 0, "서울시 서대문구 8층 2억 4500만원 방입니다."))
        mRoomList.add(Room(24500,"서울시 남대문구", 0, "서울시 남대문구 5층 1억 4500만원 방입니다."))
        mRoomList.add(Room(24500,"서울시 은평구", 0, "서울시 은평구 7층 3억 4500만원 방입니다."))
